...
Suppose that a vector of observed counts $y=(125,18,20,34)$ arises from a multinomial distribution with cell-probabilities $(\frac{1}{2}+\frac{\theta}{4}, \frac{1-\theta}{4}, \frac{1-\theta}{4}, \frac{\theta}{4})$. The aim is to find the ML estimate of $\theta$. The density of the observed data is $$
