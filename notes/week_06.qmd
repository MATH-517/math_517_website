...
If $\| \mathbf{J}(\theta^\star) \| < 1$, then $M$ is a contraction (it maps points closer together) and we may hope for convergence, by the contraction mapping theorem. 
...
**Proposition.** (Lange, 2013, Proposition 12.4.4) Suppose that all stationary points of $f(\mathbf{x})$ are isolated and that the stated differentiability, coerciveness, and convexity assumptions are true. 
