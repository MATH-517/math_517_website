...
#| layout-ncol: 3
#| out-width: 30%
#| fig-cap: "Riemann sum, trapezoidal rule, and Simpson's rule. Simpson's rule is missing the grid, sorry about that -- imagine that there is the same grid as on the first two plots, and the function is approximated quadratically between every two neighboring grid points. Source: wiki."
knitr::include_graphics('../images/numerical_integration/local_constant_rule.png')
knitr::include_graphics('../images/numerical_integration/local_linear_rule.png')
knitr::include_graphics('../images/numerical_integration/local_quadratic_rule.png')
```
