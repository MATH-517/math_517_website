...
-   Implement a Metropolis--Hastings algorithm for obtaining MCMC samples of $\mu \mid Y=y$ using $N(\tilde{y}, 0.6)$ as the proposal distribution where $\tilde{y}$ is the last sample of the chain.
