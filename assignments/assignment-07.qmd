...
You are not required to code the bootstrap procedure by yourself and can use any library you want. However, you should be able to explain the code you use.
...
- `Python`: [`arch`](https://arch.readthedocs.io/en/latest/bootstrap/generated/generated/arch.bootstrap.CircularBlockBootstrap.conf_int.html#arch.bootstrap.CircularBlockBootstrap.conf_int)
- `Julia`: [`Bootstrap.jl`](https://github.com/juliangehring/Bootstrap.jl)


**Be careful of the parametrization of an exponential distribution in the different languages!**
